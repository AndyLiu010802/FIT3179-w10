const chart2 = {
    ...
    "scales": [
        ...
        },
        {
            ...
            "zero": true,
            "nice": false,
            "domain": { "data": "table", "field": "Wages_and_salaries" },
            "domainMin": 0
        },
        {
            "name": "color",
            ...
            "marks": [
                {
                    ...
                    "encode": {
                        "enter": {
                            ...
                            "x": { "signal": "scale('radial', datum['Wages_and_salaries']) * cos(scale('angular', datum.Region))" },
                            "y": { "signal": "scale('radial', datum['Wages_and_salaries']) * sin(scale('angular', datum.Region))" },
                ...
                },
                {
                    ...
                    "encode": {
                        "enter": {
                            ...
                            "stroke": { "value": "black" },
                            "strokeWidth": { "value": 1 },
                            "tooltip": { "signal": "{'Region': datum.Region, 'Year': datum.Year, 'Wages and Salaries': datum['Wages_and_salaries']}" }
                        }
                    }
                }
            ]
...
function updateChart2(year) {
    ...
    vegaEmbed('#chart2', updatedSpec).catch(console.error);
}
